...
def design_brief():
    ...
    if kind == "news":
        ...
        print("  ▸ الجمهور: بلا خبرة تقنية. لا مصطلحات بلا شرح، وابدأ من ألم")
        print("    يفهمه الجميع لا من التقنية. أداة واحدة مجانية تعمل من الهاتف.")
        print("  ▸ مشهد الدعوة يحمل \"keyword\": \"أداة\" — ثابتة لا تتغيّر.")
        print("    ونصّه يَعِد برد تحت التعليق لا برسالة خاصة: لا نملك")
        print("    قدرة الرسائل الخاصة، وManyChat المجانية لا تغطي كل")
        print("    المنشورات. اكتب «أرد عليك… تحت تعليقك» لا «سيصلك».")
        print("  ▸ ضع في ملف الريلز \"tool\" (اسم ورابط) و\"reply\" (نص الرد")
        print("    العلني كاملاً)، ثم انقلهما إلى posts.json بعد النشر.")
        print("    الرابط لا يظهر على الشاشة: نص الفيديو غير قابل للنقر،")
        print("    والرد على التعليق هو ما يوصله. بلا reply مكتفٍ بذاته")
        print("    الريلز يَعِد بشيء لا يصل — لا تنشره.")
