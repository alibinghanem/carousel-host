...
def design_brief():
    ...
    print("  ▸ الموضوع: أداة أو تقنية جديدة وقوية فعلاً — لا مهارة حياتية")
    print("    عامة (رُفضت صيغة \"كيف تقرأ عقداً\" ونحوها صراحةً: تافهة")
    print("    ومكرّرة). اختر ما صدر أو تحدّث أخيراً أو قدرة غير معروفة")
    print("    للكثيرين، واشرحها بلغة يفهمها غير المتخصص. تجربة حقيقية —")
    print("    ما طلبتَه من الأداة فعلاً، وما خرج فعلاً. تجربة لا وصف.")
    if False:
        ...
        print("  ▸ بلا موسيقى وبلا صوت قطعات (بطلب صريح ٢٠٢٦-٠٩-١٣) — الفيديو")
        print("    صامت عمداً. الانتقال بين المشاهد مزج هادئ لا قطع حادّ، وبلا")
        print("    نبض متكرر في الخلفية. التفاصيل في DAILY_TASK.md.")
        print("  ▸ التصميم تلقائي التكيّف: الثيم الفاتح، تخطيط الغلاف")
        print("    (classic/spotlight)، تخطيط الفائدة (list/grid)، والزخرفة")
        print("    كلها من بذرة المحتوى — لا تحدّدها يدوياً إلا لضرورة.")
        print("    ورمز أي مفهوم ملموس (سيارة، منزل، هاتف…) يُستنتج تلقائياً")
        print("    من النص عبر reel_art.guess_icon فيظهر رسمه لا رقماً مجرّداً.")
