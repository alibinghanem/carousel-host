...
def design_brief():
    ...
    print("  ▸ الموضوع: مهمّ ويلامس احتياج عامة الناس، لا تجربة تقنية ضيقة")
    print("    تهمّ المهتمّين فقط. ابدأ من مسألة يعيشها كثيرون (عقد، فاتورة،")
    print("    قرار شراء، وقت مهدور)، ثم أرِ كيف يحلّها وكيل ذكاء اصطناعي")
    print("    أو أداة فعلاً — ما طلبتَه منه، وما خرج فعلاً. تجربة لا وصف.")
    if False:
