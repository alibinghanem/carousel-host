...
def design_brief():
    ...
    if kind == "news":
        ...
        print("  ▸ مشهد الدعوة يحمل حقل \"keyword\": كلمة عربية واحدة يكتبها")
        print("    المشاهد في التعليقات ليصله الرابط. سجّلها في posts.json")
        print("    مع حقل \"reply\" — نص الرد الذي يُرسل للمعلّقين.")
